    ...
    */
    ...
    ext.A_sound_note = function(note, noteduration) {
        ...
        if (noteduration == menus[lang]['noteduration'][0]) {
            ...
            duration = 2;
        } else if (n oteduration == menus[lang]['noteduration'][4]) {
            duration = 4;
        }
...
*/
    ...
    var blocks = {
        en: [
            ...
            [" ", "play note %m.notes during %m.noteduration ", "A_sound_note", "C1", "Half"],
        ...
        gr: [
            ...
            [" ", "όρισε το χρώμα του ρομπότ %n σε %m.light", "scratch_set_leds", 0, "όλα"],
